package com.shoshore.agentservice.utils.criteria;
...
public class CriteriaUtils<T> {
    ...
    public Predicate buildConjunctionPredicate(Predicate conjunctionPredicate, final CriteriaBuilder criteriaBuilder, Expression<Boolean> expression, LocalDate startTime) {
        return criteriaBuilder.and(conjunctionPredicate, expression);
    }
